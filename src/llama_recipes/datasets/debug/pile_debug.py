...
class _IndexReader(object):
    ...
    def __init__(self, idx_path: str, multimodal: bool) -> None:
        ...
        # TODO: re-split documents so that each chunck end-up as a sequence of 4096 [is it okay to have ] 
...
class PILEDataset(Dataset):
    ...
    def __getitem__(self, index: int) -> dict[str, torch.Tensor]:
        ...
        if self.partition == "train":
            sequence_pointer, sequence_length, sequence_mode = self.batches[index]
        else: 
        ...
        if padding_size > 0:
            ...
            assert(False) # this statement should not be called
